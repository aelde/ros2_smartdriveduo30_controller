...
{
  new (message_memory) popo::srv::Command_Request(_init);
}

void Command_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<popo::srv::Command_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_Request_message_member_array[1] = {
  {
    ...
    offsetof(popo::srv::Command_Request, cmd),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(popo::srv::Command_Request),
...
{
  return &::popo::srv::rosidl_typesupport_introspection_cpp::Command_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, popo, srv, Command_Request)() {
  return &::popo::srv::rosidl_typesupport_introspection_cpp::Command_Request_message_type_support_handle;
}
...
void Command_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) popo::srv::Command_Response(_init);
}

void Command_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<popo::srv::Command_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(popo::srv::Command_Response, feedback),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(popo::srv::Command_Response),
...
{
  return &::popo::srv::rosidl_typesupport_introspection_cpp::Command_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, popo, srv, Command_Response)() {
  return &::popo::srv::rosidl_typesupport_introspection_cpp::Command_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Command_service_members = {
  ...
  // see get_service_type_support_handle<popo::srv::Command>()
...
get_service_type_support_handle<popo::srv::Command>()
{
  ...
  auto service_type_support =
    &::popo::srv::rosidl_typesupport_introspection_cpp::Command_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, popo, srv, Command)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<popo::srv::Command>();
}
