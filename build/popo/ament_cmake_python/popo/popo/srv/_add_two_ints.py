...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from popo.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from popo.srv._add_two_ints import AddTwoInts_Request as Request
    from popo.srv._add_two_ints import AddTwoInts_Response as Response
