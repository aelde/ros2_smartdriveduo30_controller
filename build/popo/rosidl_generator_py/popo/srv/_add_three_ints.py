...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from popo.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from popo.srv._add_three_ints import AddThreeInts_Request as Request
    from popo.srv._add_three_ints import AddThreeInts_Response as Response
