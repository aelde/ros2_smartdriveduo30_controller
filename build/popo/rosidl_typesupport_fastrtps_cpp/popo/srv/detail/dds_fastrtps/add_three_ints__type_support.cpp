...
#include "popo/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const popo::srv::AddThreeInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  popo::srv::AddThreeInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
...
{
  auto typed_message =
    static_cast<const popo::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<popo::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &popo::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, popo, srv, AddThreeInts_Request)() {
  return &popo::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_popo
cdr_serialize(
  const popo::srv::AddThreeInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  popo::srv::AddThreeInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
...
{
  auto typed_message =
    static_cast<const popo::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<popo::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &popo::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, popo, srv, AddThreeInts_Response)() {
  return &popo::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &popo::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, popo, srv, AddThreeInts)() {
  return &popo::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
