...
#include "popo/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const popo::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<popo::srv::Command_Request *>(
    untyped_ros_message);
...
{
  return &popo::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const popo::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<popo::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &popo::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &popo::srv::typesupport_fastrtps_cpp::_Command__handle;
}
