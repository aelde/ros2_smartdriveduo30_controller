...
{
  new (message_memory) popo::srv::AddTwoInts_Request(_init);
}

void AddTwoInts_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<popo::srv::AddTwoInts_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddTwoInts_Request_message_member_array[2] = {
  {
    ...
    offsetof(popo::srv::AddTwoInts_Request, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(popo::srv::AddTwoInts_Request, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddTwoInts_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(popo::srv::AddTwoInts_Request),
...
get_message_type_support_handle<popo::srv::AddTwoInts_Request>()
{
  return &::popo::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, popo, srv, AddTwoInts_Request)() {
  return &::popo::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Request_message_type_support_handle;
}
...
void AddTwoInts_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) popo::srv::AddTwoInts_Response(_init);
}

void AddTwoInts_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<popo::srv::AddTwoInts_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddTwoInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(popo::srv::AddTwoInts_Response, sum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddTwoInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(popo::srv::AddTwoInts_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<popo::srv::AddTwoInts_Response>()
{
  return &::popo::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, popo, srv, AddTwoInts_Response)() {
  return &::popo::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers AddTwoInts_service_members = {
  ...
  // see get_service_type_support_handle<popo::srv::AddTwoInts>()
...
get_service_type_support_handle<popo::srv::AddTwoInts>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::popo::srv::rosidl_typesupport_introspection_cpp::AddTwoInts_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, popo, srv, AddTwoInts)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<popo::srv::AddTwoInts>();
}
